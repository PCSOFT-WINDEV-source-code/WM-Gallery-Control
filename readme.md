...
<span style="font-family:Arial sans-serif;font-size:16px;">WM Gallery Control</span>

  
<span style="font-family:Arial sans-serif;font-size:14px;">This example shows how to use the "Image Gallery" control.</span>
